...
// netlify/functions/skymail-send.ts
var skymail_send_exports = {};
__export(skymail_send_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(skymail_send_exports);
...
var handler = async (event) => {
  ...
  try {
    ...
    const preparedAttachments = attachmentsInput.map((item) => {
...
//# sourceMappingURL=skymail-send.js.map
