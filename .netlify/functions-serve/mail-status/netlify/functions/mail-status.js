...
// netlify/functions/mail-status.ts
var mail_status_exports = {};
__export(mail_status_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(mail_status_exports);
...
function resolveSenderSource(smtpUser) {
...
//# sourceMappingURL=mail-status.js.map
