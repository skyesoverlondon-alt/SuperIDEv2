...
// netlify/functions/skyedrive-push.ts
var skyedrive_push_exports = {};
__export(skyedrive_push_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(skyedrive_push_exports);
...
var handler = async (event) => {
  ...
  const incomingFiles = Array.isArray(body.files) ? body.files : void 0;
  ...
  const snapshotTitle = title || `${workspace.name || "SkyDex Workspace"} \xB7 SkyeDrive Snapshot`;
  const payload = {
...
//# sourceMappingURL=skyedrive-push.js.map
