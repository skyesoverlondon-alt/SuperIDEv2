...
// netlify/functions/github-app-connect.ts
var github_app_connect_exports = {};
__export(github_app_connect_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(github_app_connect_exports);
...
var handler = async (event) => {
  ...
  await q(
    "insert into integrations(user_id, github_repo, github_owner, github_branch, github_installation_id) values($1,$2,$3,$4,$5) on conflict(user_id) do update set github_repo=excluded.github_repo, github_owner=excluded.github_owner, github_branch=excluded.github_branch, github_installation_id=excluded.github_installation_id, updated_at=now()",
...
//# sourceMappingURL=github-app-connect.js.map
