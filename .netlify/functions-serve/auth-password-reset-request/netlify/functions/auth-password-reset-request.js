...
// netlify/functions/auth-password-reset-request.ts
var auth_password_reset_request_exports = {};
__export(auth_password_reset_request_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(auth_password_reset_request_exports);
...
var EMAIL_RE = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
function hasMailDeliveryConfig() {
...
var handler = async (event) => {
  try {
    ...
    if (!EMAIL_RE2.test(normalizedEmail)) {
...
//# sourceMappingURL=auth-password-reset-request.js.map
