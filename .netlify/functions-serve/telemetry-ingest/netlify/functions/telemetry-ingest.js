...
// netlify/functions/telemetry-ingest.ts
var telemetry_ingest_exports = {};
__export(telemetry_ingest_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(telemetry_ingest_exports);
