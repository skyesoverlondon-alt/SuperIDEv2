...
// netlify/functions/skyesheets-list.ts
var skyesheets_list_exports = {};
__export(skyesheets_list_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(skyesheets_list_exports);
...
//# sourceMappingURL=skyesheets-list.js.map
