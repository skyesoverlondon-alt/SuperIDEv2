...
// netlify/functions/site-config.js
var DEFAULT_CONFIG = {
  announcement: "s0l26 0s \xB7 skAIxuIDEpro is part of the Creative Environment Eco-System by Skyes Over London and kAIxU.",
...
var handler = async (event, context) => {
  ...
  try {
    ...
    const next = {
      ...
      announcement: String(body.announcement || DEFAULT_CONFIG.announcement).slice(0, 2e3),
