...
var identity_signup_exports = {};
__export(identity_signup_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(identity_signup_exports);
...
var handler = async (event) => {
  try {
    ...
    return json(200, { ok: true, note: error.message || "identity signup sync skipped" });
  }
};
