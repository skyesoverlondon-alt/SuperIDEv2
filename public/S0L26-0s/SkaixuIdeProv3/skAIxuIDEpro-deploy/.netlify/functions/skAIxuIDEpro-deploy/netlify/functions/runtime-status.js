...
var runtime_status_exports = {};
__export(runtime_status_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(runtime_status_exports);
...
var handler = async (event) => {
  ...
  return json(200, {
    ...
    database_configured: Boolean(process.env.NEON_DATABASE_URL || process.env.NETLIFY_DATABASE_URL),
