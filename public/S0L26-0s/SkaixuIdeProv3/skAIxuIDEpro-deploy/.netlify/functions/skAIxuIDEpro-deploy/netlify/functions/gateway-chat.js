...
var gateway_chat_exports = {};
__export(gateway_chat_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(gateway_chat_exports);
...
function jsonResponse({ outputText, usage, brand, resolvedModel }, month = null) {
  return {
    id: `kaixu_${Date.now()}`,
